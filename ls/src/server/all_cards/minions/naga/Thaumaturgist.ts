...
/**
 * Thaumaturgist类 - 继承自Minion，实现Thaumaturgist随从
 */
export class Thaumaturgist extends Minion {
...
const BASE_DATA = {
  ...
  "name": "Thaumaturgist",
  "nameCN": "杂耍奇术师",
  "text": "<b>塑造法术：</b>直到下个回合，使一个随从获得+{1}/+{1}。<i>（在本局对战中，你每施放4个法术都会提升！）</i>",
  "mechanics": [
    "TRIGGER_VISUAL"
  ],
  "referencedTags": [],
  "img": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_battlegroundsImage.png",
  "art": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_cardArtFromHsJson256x.png",
  "tokens": [
    {
      "id": 116111,
      "strId": "BG31_924t",
  ...
  "upgradeCard": {
    ...
    "referencedTags": [],
    "img": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_G_battlegroundsImageGold.png",
    "art": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_G_cardArtFromHsJson256x.png",
    "tokens": [
      {
        "id": 116113,
        "strId": "BG31_924_Gt",
        ...
        "mechanics": [],
        "referencedTags": [],
        "img": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_Gt_battlegroundsImage.png",
        "art": "https://battlegrounds.oss.gamerhub.cn/all_images/32.2.4.221850/BG31_924_Gt_cardArtFromHsJson256x.png"
      },
      {
        "id": 115556,
        "strId": "BG31_920_G",
