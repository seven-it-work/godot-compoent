import { BasicGrowthAttribute, BasicRangeGrowthAttribute } from "@/v1/growthAttribute/impl";
import RandomUtils from "@/v1/utils/RandomUtils";
import { SPIRIT_ROOT_TYPES, type SpiritRoot, type SpiritRootType } from "./define";
